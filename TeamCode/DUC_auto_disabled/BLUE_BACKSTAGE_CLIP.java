...
public class BLUE_BACKSTAGE_CLIP extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        MecanumDrive drive = new MecanumDrive(hardwareMap, initialPose, 0, 0);
        ...
        TrajectoryActionBuilder strafeToHighRung = drive.actionBuilder(initialPose, 0, 0)
                .strafeToLinearHeading(highRung, Math.toRadians(90));

        TrajectoryActionBuilder parkTier1Ascent = drive.actionBuilder(new Pose2d(-10, 28, Math.toRadians(270)), 0, 0)
