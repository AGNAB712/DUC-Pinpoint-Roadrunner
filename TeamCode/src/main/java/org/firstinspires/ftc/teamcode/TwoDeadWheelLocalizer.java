...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 0.04273249951036301; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 0.23905898789133995; // x position of the perpendicular encoder (in tick units)
    }
