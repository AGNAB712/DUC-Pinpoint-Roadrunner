...
@Config
@Autonomous(name = "1BLUE BACKSTAGE SAMPLE", group = "Autonomous")
public class BLUE_BACKSTAGE_SAMPLE extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        Pose2d initialPose = new Pose2d(32, 64, Math.toRadians(1));
        ...
        TrajectoryActionBuilder trajectory1 = drive.actionBuilder(new Pose2d(61, 61, Math.toRadians(45))) //basket to first sample
                .strafeToLinearHeading(new Vector2d(46.5, 45), Math.toRadians(270));

        TrajectoryActionBuilder trajectory2 = drive.actionBuilder(new Pose2d(47, 45, Math.toRadians(270))) //first sample to basket
                .strafeToLinearHeading(new Vector2d(56, 54), Math.toRadians(224))
                .strafeToLinearHeading(new Vector2d(58, 48), Math.toRadians(45))
                .strafeTo(new Vector2d(59, 63.5));

        TrajectoryActionBuilder trajectory3setup = drive.actionBuilder(new Pose2d(61, 61, Math.toRadians(45))) //basket to second sample
                .strafeToLinearHeading(new Vector2d(56, 54), Math.toRadians(224));

        TrajectoryActionBuilder trajectory3 = drive.actionBuilder(new Pose2d(56, 54, Math.toRadians(224))) //basket to second sample
                .strafeToLinearHeading(new Vector2d(59.5, 45), Math.toRadians(270));

        TrajectoryActionBuilder trajectory2setup = drive.actionBuilder(new Pose2d(59.5, 45, Math.toRadians(270))) //basket to second sample
                .strafeToLinearHeading(new Vector2d(57.5, 54), Math.toRadians(224));

        TrajectoryActionBuilder trajectory2alt = drive.actionBuilder(new Pose2d(57.5, 54, Math.toRadians(224))) //second sample to basket
                .strafeToLinearHeading(new Vector2d(57-xpos1, 48-ypos1), Math.toRadians(45))
                .strafeTo(new Vector2d(56 - xpos1, 61.5 - ypos1));

        TrajectoryActionBuilder trajectory2last = drive.actionBuilder(new Pose2d(60.5-xpos1, 28-ypos1, Math.toRadians(1))) //third sample to basket
                .strafeTo(new Vector2d(56, 28))
                .strafeToLinearHeading(new Vector2d(60.5, 60.5), Math.toRadians(45));

        TrajectoryActionBuilder trajectory4 = drive.actionBuilder(new Pose2d(59.5, 59, Math.toRadians(45))) //basket to third sample
                .strafeToLinearHeading(new Vector2d(53, 28), Math.toRadians(1))
                .strafeTo(new Vector2d(60.5, 28));

        TrajectoryActionBuilder trajectory5 = drive.actionBuilder(new Pose2d(59.5, 61, Math.toRadians(45))) //park
