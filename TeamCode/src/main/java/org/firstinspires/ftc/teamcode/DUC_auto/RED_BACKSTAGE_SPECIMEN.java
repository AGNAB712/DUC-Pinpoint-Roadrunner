...
@Config
@Autonomous(name = "1RED BACKSTAGE MAX SPECIMEN", group = "Autonomous")
public class RED_BACKSTAGE_SPECIMEN extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder trajectory0 = drive.actionBuilder(new Pose2d(11, -63.21, Math.toRadians(270.00))) //strafe from beginning to high rung
                .strafeTo(new Vector2d(2.29, -32));



        TrajectoryActionBuilder trajectory1 = drive.actionBuilder(new Pose2d(2.29, -32, Math.toRadians(270.00))) //flipper part 1 position
                .strafeToLinearHeading(new Vector2d(45, -43.5), Math.toRadians(50.00));

        TrajectoryActionBuilder trajectory2 = drive.actionBuilder(new Pose2d(45, -43.5, Math.toRadians(50.00))) //flipper part 1 flip
                .strafeToLinearHeading(new Vector2d(45, -45.5), Math.toRadians(290.00));

        TrajectoryActionBuilder trajectory3 = drive.actionBuilder(new Pose2d(45, -45.5, Math.toRadians(310.00))) //flipper part 2 position
                .strafeToLinearHeading(new Vector2d(53, -43.5), Math.toRadians(55.00));

        TrajectoryActionBuilder trajectory4 = drive.actionBuilder(new Pose2d(53, -43.5, Math.toRadians(40.00))) //fliper part 2 flip
                .strafeToLinearHeading(new Vector2d(45.5, -45.5), Math.toRadians(290.00));

        TrajectoryActionBuilder beforePicking = drive.actionBuilder(new Pose2d(45.5, -45.5, Math.toRadians(310.00)))
                .strafeToLinearHeading(new Vector2d(47, -56), Math.toRadians(90));

        TrajectoryActionBuilder picking = drive.actionBuilder(new Pose2d(47, -52.29, Math.toRadians(90.00)))
                .strafeToLinearHeading(new Vector2d(47, -64), Math.toRadians(90));

        TrajectoryActionBuilder rung = drive.actionBuilder(new Pose2d(47, -64, Math.toRadians(90.00)))
                .strafeToLinearHeading(new Vector2d(7.75, -31.29), Math.toRadians(270));

        TrajectoryActionBuilder beforePickingFromRung = drive.actionBuilder(new Pose2d(7.75, -31.29, Math.toRadians(270.00)))
                .strafeToLinearHeading(new Vector2d(47, -56), Math.toRadians(90));
